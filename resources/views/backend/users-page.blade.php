...
@section('content')
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">User Table
                    <div class="text-muted pt-2 font-size-sm">Manage Users</div>
                </h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <button type="button" class="btn btn-primary font-weight-bolder" data-bs-toggle="modal" data-bs-target="#add-user-overlay">
    ...
    @include('backend.includes.overlay._add-new-user');
@endsection
